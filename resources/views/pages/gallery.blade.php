...
<div class="container-fluid">
  ...
  <div class="lightboxgallery-gallery clearfix" id="div-item300" >
    ...
    @for ($i = 26; $i < 45; $i++)
      ...
      <a class="lightboxgallery-gallery-item item300" target="_blank" href="{{asset("images/gallery/300/$i.jpg")}}"  data-title="CBM_{{$item}} - $300.00" data-alt="80X50" data-desc="80X50">
        <div>
          <img style="max-height:230px;" src="{{asset("images/gallery/300/$i.jpg")}}" title="Cuadro" alt="Cuadro">
          <div class="lightboxgallery-gallery-item-content">
            <span class="lightboxgallery-gallery-item-title">CBM-{{$item}}| 80X50 | $300.00</span>
          </div>
        </div>
      </a>
      @php
  ...
  <div class="lightboxgallery-gallery clearfix" id="div-item750" style="display:none">
    @for ($i = 1; $i < 11; $i++)
      <a class="lightboxgallery-gallery-item item750" target="_blank" href="{{asset("images/gallery/750/$i.jpg")}}"  data-title="CBM_{{$item}} - $750.00" data-alt="1.1X60" data-desc="1.1X60">
        <div>
          <img style="" src="{{asset("images/gallery/750/$i.jpg")}}" title="Cuadro" alt="Cuadro">
          <div class="lightboxgallery-gallery-item-content">
            <span class="lightboxgallery-gallery-item-title">CBM-{{$item}} | 1.1X60 | $750.00</span>
          </div>
        </div>
      </a>
      @php
  ...
  <div class="lightboxgallery-gallery clearfix" id="div-item800" style="display:none">
    @for ($i = 11; $i < 18; $i++)
      <a class="lightboxgallery-gallery-item item800" target="_blank" href="{{asset("images/gallery/800/$i.jpg")}}" data-title="CBM_{{$item}} - $800.00" data-alt="1.50X80" data-desc="1.50X80">
        <div>
          <img style="max-height:200px;" src="{{asset("images/gallery/800/$i.jpg")}}" title="Cuadro" alt="Cuadro">
          <div class="lightboxgallery-gallery-item-content">
            <span class="lightboxgallery-gallery-item-title">CBM-{{$item}} | 1.50X80 | $800.00</span>
          </div>
        </div>
      </a>
      @php
  ...
  <div class="lightboxgallery-gallery clearfix" id="div-item700" style="display:none">
    <!--1X70 $700.00 -->
    @for ($i = 18; $i < 26; $i++)
      <a class="lightboxgallery-gallery-item item700" target="_blank" href="{{asset("images/gallery/700/$i.jpg")}}" data-title="CBM_{{$item}} - $700.00" data-alt="1X70" data-desc="1X70">
        <div>
          <img style="max-height:200px;" src="{{asset("images/gallery/700/$i.jpg")}}" title="Cuadro" alt="Cuadro">
          <div class="lightboxgallery-gallery-item-content">
            <span class="lightboxgallery-gallery-item-title">CBM-{{$item}} | 1X70 |  $700.00</span>
          </div>
        </div>
      </a>
      @php
  ...
  <div class="lightboxgallery-gallery clearfix" id="div-item400" style="display:none">
    <!--90X60 $400.00 -->
    @for ($i = 45; $i < 57; $i++)
      <a class="lightboxgallery-gallery-item item400" target="_blank" href="{{asset("images/gallery/400/$i.jpg")}}" data-title="CBM_{{$item}} - $400.00" data-alt="90X60" data-desc="90X60">
        <div>
          <img style="" src="{{asset("images/gallery/400/$i.jpg")}}" title="Cuadro" alt="Cuadro">
          <div class="lightboxgallery-gallery-item-content">
            <span class="lightboxgallery-gallery-item-title">CBM-{{$item}} | 90X60 | $400.00</span>
          </div>
        </div>
      </a>
      @php
